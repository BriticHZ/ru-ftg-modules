...
class NotesMod(loader.Module):
    ...
    strings = {"name": "Заметки",
               "what_note": "<b>Название заметки?</b>",
               "no_note": "<b>Заметка не найдена</b>",
               "save_what": "<b>Вы должны ответить на сообщение, чтобы сохранить его в заметке, или выбрать заметку.</b>",
               ...
               "delnote_args": "<b>Какую заметку надо удалить?</b>",
               "delnote_done": "<b>Заметка удалена</b>",
               "delnotes_none": "<b>Тут нету заметок, чтобы очистить</b>",
               "delnotes_done": "<b>Все заметки были удалены</b>",
               "notes_none": "<b>Нету сохраненных заметок</b>"}
